...
public class FragmentHome extends Fragment implements AdapterProduct.OnPhoneClickListener{
    ...
    public void onViewCreated(View view, Bundle savedInstanceState){
        ...
        ItemProduct itemProduct = new ItemProduct(2, "Pillows", "BestBuy", "Zapopan, Jalisco", "33 12345678",
                "Llevate las almohadas mas comodas del mercado a la mitad de precio");

        ItemProduct itemProduct1 = new ItemProduct(3, "Sheets", "BestBuy", "Zapopan, Jalisco", "33 87654321",
                "Llevate las sábanas más suaves del mercado con un 30% de descuento");
